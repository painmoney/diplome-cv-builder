...
const TIP_TYPE_TEMPLATES = {
  ...
  "message-broker": {
    ...
    safeActions: [
      "Укажите {name} в описании проекта: очереди, топики,消费者/производители",
      "Опишите задачу: асинхронная обработка, event-driven, декомпозиция",
      "Если был в рабочем проекте — добавьте контекст и результат",
    ],
    avoid: [
      "Не пишите «опыт с {name}», если он только в списке навыков",
  ...
  architecture: {
    description:
      "{name} указан в навыках, но не подтверждён опытом. Если вы применяли {name} в проекте, укажите это в описании проекта или опыта.",
    safeActions: [
      "Укажите {name} в описании проекта: как применяли, в каком контексте",
      "Опишите результат: структура, масштабируемость, поддерживаемость",
      "Если был в рабочем проекте — добавьте контекст",
    ],
    avoid: [
      "Не пишите «применял {name}», если только знаете теорию",
      "Не выставляйте {name} как ключевой навык без реального опыта",
    ],
  },
  methodology: {
    description:
    ...
    safeActions: [
      "Укажите {name} в описании проекта: как применяли, в каком контексте",
      "Опишите результат: процесс, команда, эффективность",
      "Если был в рабочем проекте — добавьте контекст",
    ],
    avoid: [
      "Не пишите «применял {name}», если только знаете теорию",
