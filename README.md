...
Команда создаёт ZIP в `safe-packages/` только из файлов, которые отслеживаются Git в
последнем коммите. Локальные секреты и служебные папки в такой архив не попадут.
